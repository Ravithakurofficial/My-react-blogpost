...
import SignIn from "./siginmodal"; // Assuming you have a separate file for the SignIn component

function Modals({ showModal, handleCloseModal }) {
    const [showSignInModal, setShowSignInModal] = useState(false); // State variable to determine which modal to show initially

    // Function to toggle between sign-in and sign-up modals
    const toggleModal = () => {
            ...
            <div className="modal" tabIndex="-1" role="dialog" style={{ display: 'flex' }}>
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        {showSignInModal ? (
                            <SignIn handleCloseModal={handleCloseModal} toggleModal={toggleModal} />
                        ) : (
                            <div>
                                ...
                                <div className="px-4">
                                    <div className="d-flex justify-content-between align-items-center mb-4">
                                        ...
                                        <button className="btn" data-fdprocessedid="n1c408" onClick={toggleModal}>
                                            Already have an account? <span className="text-primary" id="sign-in">Sign In</span>
                                        </button>
                                    </div>
