                ...
                <div className="modal-content">
                    ...
                    <div className="px-4">
                        <div className="d-flex justify-content-between  align-items-center mb-4">
                            <h4 className="d-flex fw-bold" id="update">welcome Back</h4>
                            <button className="btn" data-fdprocessedid="n1c408">or, <span className="text-primary" id="sign-in">Create Account</span>
                            </button>
                        </div>
