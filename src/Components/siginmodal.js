...
function SigninModals({ showModal, handleCloseModal }) {
    return (
        showModal && (
            <div className="modal" tabIndex="-1" role="dialog" style={{ display: 'block', width: '100%' }} key="signin-modal">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="px-4">
                            <div className="d-flex justify-content-between  align-items-center mb-4">
                                <h4 className="d-flex fw-bold" id="update">Sign In</h4>
                                <button className="btn" data-fdprocessedid="n1c408">Don't have an account? <span className="text-primary" id="sign-up">Sign Up</span></button>
                            </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col">
                                        <div className="d-flex flex-column">
                                            ...
                                            <p className="info-signup">By signing in, you agree to our Terms &amp; conditions,
                                                Privacy
                                                policy</p>
                                        </div>
                                    </div>
